...
const MatchData = () => {
  ...
  const [primaryColor, setPrimaryColor] = useState("#FF0000"); // Default color (red)
  const [currentDataIndex, setCurrentDataIndex] = useState(0); // Track current index for pagination
